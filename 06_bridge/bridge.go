...
func NewSuccessNotification(sender IMsgSender) *SuccessNotification {
	return &SuccessNotification{sender: sender}
}

func (n *SuccessNotification) Notify(msg string) error {
	return n.sender.Send(msg)
}
